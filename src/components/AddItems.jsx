        ...
        <Controller
          ...
          render={({ field }) => (
            <Select
              ...
              suffixIcon={""}
            >
              <Option value="Internet Sakti">Internet Sakti</Option>
              <Option value="Internet Spesial">Internet Spesial</Option>
              <Option value="Internet Bulanan">Internet Bulanan</Option>
              <Option value="Internet Mingguan">Internet Mingguan</Option>
            </Select>
          )}
        />
        {errors.category && (
