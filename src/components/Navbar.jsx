...
import ecommerceImage from "../../public/dnet-logo.png";
  ...
  return (
    <Navbar onMenuOpenChange={setIsMenuOpen} className="poppins">
      <NavbarContent>
        ...
        />
        <NavbarBrand>
  <p className="font-bold text-inherit md:text-center cursor-pointer flex justify-center items-center gap-4">
    <span className="w-20 mr-2">
      <img src={ecommerceImage} alt="" />
    </span>
    {/* <span className="text-black-400 md:text-lg text-medium hover:text-gray-500">
      E-Com
    </span>
    <span className="text-gray-500 md:text-lg text-medium hover:text-black-400">
      merce
    </span> */}
  </p>
</NavbarBrand>
